...
const ContactSection = () => {
  return (
    <section id="contact" className="pt-10 pb-20 max-w-300 mx-auto px-4"> {/* Fixed CSS */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        <div className="md:col-span-5 relative group">
          <div className="h-full bg-secondary/30 border border-border/20 p-8 md:p-10 rounded-[2.5rem] flex flex-col justify-between overflow-hidden relative backdrop-blur-md">
             ...
             <div className="relative z-10">
               ...
               <p className="text-tertiary-content mt-6 text-sm leading-relaxed max-w-70"> {/* Fixed CSS */}
        ...
        <div className="md:col-span-7 bg-secondary/30 border border-border/20 p-8 md:p-12 rounded-[2.5rem] backdrop-blur-xl relative shadow-2xl">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-px bg-linear-to-r from-transparent via-accent/50 to-transparent" /> {/* Fixed CSS */}
