...
export const PhoneIcon: FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    ...
    {...props}
  >
    {/* Centered path to prevent clipping */}
    <path 
      d="M6.62 10.79a15.15 15.15 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.11-.27c1.12.45 2.33.69 3.58.69a1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A19 19 0 0 1 3 4a1 1 0 0 1 1-1h3.5a1 1 0 0 1 1 1c0 1.25.24 2.46.69 3.58a1 1 0 0 1-.27 1.11l-2.3 2.1z" 
      fill="currentColor" 
    />
  </svg>
)

/** * SOCIAL MEDIA ICONS (Inlined to prevent "Module not found" errors)
 */
